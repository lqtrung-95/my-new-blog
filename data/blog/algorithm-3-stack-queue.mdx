...
1. [Valid Parentheses (Easy)](#valid-parentheses-easy)

   - [Problem Description](#problem-description)
   - [Solutions](#solutions)

2. [Min Stack (Easy)](#min-stack-easy)

   - [Problem Description](#problem-description-1)
   - [Solutions](#solutions-1)

3. [Evaluate Reverse Polish Notation (Medium)](#evaluate-reverse-polish-notation-medium)

   - [Problem Description](#problem-description-2)
   - [Solutions](#solutions-2)

4. [Largest Rectangle in Histogram (Hard)](#largest-rectangle-in-histogram-hard)
