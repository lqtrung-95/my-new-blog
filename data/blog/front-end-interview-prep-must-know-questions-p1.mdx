...
- [1. How do you handle serving pages for browsers with limited features? What techniques or processes do you employ?](#1-how-do-you-handle-serving-pages-for-browsers-with-limited-features-what-techniques-or-processes-do-you-employ)
- [2. What is `"use strict";`?](#2-what-is-use-strict)
...
- [4. What's the difference between feature detection, feature inference, and using the UA string?](#4-whats-the-difference-between-feature-detection-feature-inference-and-using-the-ua-string)
  - [Feature Detection](#feature-detection)
  - [Feature Inference](#feature-inference)
  - [UA String](#ua-string)
- [5. What's the difference between "resetting" and "normalizing" CSS?](#5-whats-the-difference-between-resetting-and-normalizing-css)
  - [Which to choose and why?](#which-to-choose-and-why)
- [6. Why would you use a `srcset` attribute in an image tag?](#6-why-would-you-use-a-srcset-attribute-in-an-image-tag)
  - [Process of Evaluation by the Browser](#process-of-evaluation-by-the-browser)
- [7. Are you familiar with styling SVG?](#7-are-you-familiar-with-styling-svg)
- [8. Could you provide an illustration of a currying function and elaborate on the advantages that this syntax provides?](#8-could-you-provide-an-illustration-of-a-currying-function-and-elaborate-on-the-advantages-that-this-syntax-provides)
- [9. Can you give an example of an `@media` property other than `screen`?](#9-can-you-give-an-example-of-an-media-property-other-than-screen)
