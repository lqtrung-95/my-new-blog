...
draft: false
summary: This post serves as an introductory guide to algorithmic problems centered around Arrays & Hashing
images: []
layout: PostLayout
canonicalUrl:
---
...
- [Problem: Contains Duplicate (Easy)](#problem-contains-duplicate-easy)
  - [Examples](#examples)
  - [Solutions](#solutions)
    - [Brute Force](#1-brute-force)
    - [Sorting the Array](#2-sorting-the-array)
    - [Using a Set](#3-using-a-set)
- [Problem: Top K Frequent Elements (Medium)](#problem-top-k-frequent-elements-medium)
  - [Examples](#examples-1)
  - [Solutions](#solutions-1)
    - [Brute Force](#1-brute-force-1)
    - [Bucket Sort algorithm](#2-bucket-sort-algorithm)
- [Problem: Longest Consecutive Sequence (Medium)](#problem-longest-consecutive-sequence-medium)
  - [Examples](#examples-2)
...
When the algorithm finds a number that is the start of a consecutive sequence (i.e., num - 1 is not in the HashSet), it initiates a while loop to explore the consecutive sequence by incrementing the current number.
Since each number is explored at most once, the overall time complexity remains linear, and the total time complexity is O(n).
